# Incremental Fantasy RPG - AGENTS.md (Efficiency First)
...
"Produce a minimal implementation plan for this repo. Follow AGENTS.md response contract. Keep under 220 tokens. Include only in-scope files, concrete steps, validation commands, and done criteria. Avoid architecture recap unless required for this task."
